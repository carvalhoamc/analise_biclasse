...
class Statistics:
	...
	def grafico_variacao_alpha(self):
		...
		for m in M:
			for o in order:
				for a in alphas:
					filename = './../output_dir/results_media_rank_biclass_'+o +'_'+str(a)+ m + '.csv'
					print(filename)
					df = pd.read_csv(filename)
				...
				plt.xticks(range(11))
				fig.savefig('./../output_dir/graphics/biclass_'+o + '_'+measure+'.png',dpi=125)
				plt.show()
				plt.close()
		...
		plt.xticks(range(12))
		plt.savefig('./../output_dir/graphics/biclass_all_geo.png', dpi=800)
		plt.show()
		plt.close()
		...
		leg.get_frame().set_alpha(0.5)
		plt.xticks(range(12))
		plt.savefig('./../output_dir/graphics/biclass_all_iba.png', dpi=800)
		plt.show()
		plt.close()
		df_alpha_all.to_csv('./../output/biclass_all_alphas_rank_geo_iba.csv')
